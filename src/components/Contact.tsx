  ...
  return (
    <section className="font-(family-name:--THICCCBOI-Medium) py-[160px]">
      <div className="flex flex-col justify-center gap-6 px-[24px] 2xl:max-w-[1216px] 3xl:max-w-[1264px] mx-auto">
        ...
        <p className="text-(--neutral-600) text-[18px]/8 md:text-[22px]/10 3xl:text-[20px]/8 max-w-[700px] -mt-2">Lorem ipsum dolor sit amet tragon consectetur adipsicing elit mattis faucibus odio feugiat arcu scelerisque drogon sit.</p>

        <div className="flex items-center gap-12 flex-wrap mt-6">
          {/* TODO: Add links */}
