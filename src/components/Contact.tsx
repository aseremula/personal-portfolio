  ...
  return (
    <section className="font-(family-name:--THICCCBOI-Medium) py-[160px]">
      <div className="flex flex-col justify-center gap-8 px-[24px] max-w-[1216px] 3xl:max-w-[1264px] mx-auto">
        ...
        <button className="flex gap-2 md:gap-4 items-center cursor-pointer lightenDirect" onClick={() => window.location.href = 'mailto:yourmail@domain.com'} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() =>setIsHovered(false)}>
