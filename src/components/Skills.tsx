...
function Skills() {
  ...
  return (
    <section className="font-(family-name:--THICCCBOI-Medium) py-[160px]">
      <div className="flex flex-col justify-center gap-14 md:gap-16 px-[24px] 2xl:max-w-[1216px] 3xl:max-w-[1264px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 flex-wrap">
            ...
            <div className="flex flex-col justify-center gap-2">     
                ...
                <hr className={`border-1 border-(--neutral-800) ${(isHovered) ? "grow" : "shrink"}`}></hr>
            </div>
       </div>
