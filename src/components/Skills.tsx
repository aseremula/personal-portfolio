...
import resume from '../assets/blank.pdf';
// TODO: replace resume with actual resume up top and in link's href
    ...
    <section className="font-(family-name:--THICCCBOI-Medium) py-[160px]">
      <div className="flex flex-col justify-center gap-14 md:gap-16 px-[24px] max-w-[1216px] 3xl:max-w-[1264px] mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 flex-wrap">
          ...
          {/* NOTE: This link shares the same sizes as the link found in Projects.tsx */}
          <div className="flex flex-col justify-center gap-[10px]">     
            <a className="flex gap-2 items-center font-(family-name:--THICCCBOI-Bold) text-(--neutral-800) text-[20px] leading-[22px] lg:text-[24px] lg:leading-[26px] 3xl:text-[28px] 3xl:leading-[32px] lightenDirect" href={resume} target="_blank" rel="noopener noreferrer" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() =>setIsHovered(false)}>
              Browse resume
